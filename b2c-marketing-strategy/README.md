...
> **Companion skill in this repo:** `marketing-strategy-audit` reviews existing strategy documents (PDF / PPTX / DOCX) against a 7-criterion rubric and surfaces non-obvious insights — cross-document inconsistencies, hidden assumptions, missed opportunities in the data. Use it on your own draft before presenting, or on strategies from agencies / internal teams. See [`marketing-strategy-audit/`](../marketing-strategy-audit/) and grab the latest `.skill` from Releases.
